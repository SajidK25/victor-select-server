...
type Mutation {
  ...
  updateManyShipments(data: ShipmentUpdateManyMutationInput!, where: ShipmentWhereInput): BatchPayload!
  upsertShipment(where: ShipmentWhereUniqueInput!, create: ShipmentCreateInput!, update: ShipmentUpdateInput!): Shipment!
  deleteShipment(where: ShipmentWhereUniqueInput!): Shipment
  deleteManyShipments(where: ShipmentWhereInput): BatchPayload!
...
type Query {
  ...
  shipments(where: ShipmentWhereInput, orderBy: ShipmentOrderByInput, skip: Int, after: String, before: String, first: Int, last: Int): [Shipment]!
  shipmentsConnection(where: ShipmentWhereInput, orderBy: ShipmentOrderByInput, skip: Int, after: String, before: String, first: Int, last: Int): ShipmentConnection!
...
type ShipmentSubscriptionPayload {
  mutation: MutationType!
  node: Shipment
  updatedFields: [String!]
...
input ShipmentSubscriptionWhereInput {
  mutation_in: [MutationType!]
  updatedFields_contains: String
  updatedFields_contains_every: [String!]
  updatedFields_contains_some: [String!]
  node: ShipmentWhereInput
  AND: [ShipmentSubscriptionWhereInput!]
  OR: [ShipmentSubscriptionWhereInput!]
  NOT: [ShipmentSubscriptionWhereInput!]
}
...
type Subscription {
  ...
  shipment(where: ShipmentSubscriptionWhereInput): ShipmentSubscriptionPayload
